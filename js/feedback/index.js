...
const COMPONENT_SELECTOR = '[data-feedback]'
...
export default function() {
  const component = document.querySelectorAll(COMPONENT_SELECTOR)

  for (let i = 0; i < component.length; i++) {
    const buttons = document.querySelectorAll(BUTTON_SELECTOR)
    const templates = component[i].querySelectorAll(TEMPLATE_SELECTOR)
    ...
    const defaultSettings = {
      ...
      onMount: (tooltip) => {
        ...
        const feedbackText = component[i].querySelector(TEXT_SELECTOR)
