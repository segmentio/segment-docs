...
When you set this dropdown to Block Event, Segment drops any events that are not defined in your Tracking Plan. Only `track` calls that appear in the allow-list in your Tracking Plan flow through Segment to your Destinations.
