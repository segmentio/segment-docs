...
- **Multiple instances of the same destination:** If multiple instances of a destination are configured to a single source then the same transformation will apply across every instance. 
