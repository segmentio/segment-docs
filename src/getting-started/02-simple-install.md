...
<div class="double">
  {% include components/reference-button.html href="/getting-started/01-what-is-segment/" newtab="false" icon="symbols/arrow-left.svg" title="Back: What is Segment" description="The basics of the Segment platform and what you can do with it." variant="related" %}

  {% include components/reference-button.html href="/getting-started/03-planning-full-install/" newtab="false" icon="symbols/arrow-right.svg" title="Next: Planning a Full Installation" description="Think through your goals, plan your calls, and set yourself up for success." variant="related" %}
</div>
