...
> success ""
> **Tip**: To see a more complete view of all your events, you might consider setting up either a [warehouse](/docs/connections/warehouses/) or an [S3 destination](/docs/connections/storage/catalog/amazon-s3/).
