...
Your function is a small piece of JavaScript code in your workspace that can generate Segment events or objects using the [Segment Spec](/docs/connections/spec/).
...
The execution time limit is 3 seconds.
