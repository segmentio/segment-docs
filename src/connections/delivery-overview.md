...
The data in Delivery Overview has an expected latency of approximately 30 seconds after event ingestion, but this may vary, depending on the features you've enabled in your workspace and spikes in workplace traffic. Data visible in the Delivery Overview UI is limited to the last 5 minutes to allow for more precise metrics. 
