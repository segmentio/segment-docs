...
For best practices, Segment recommends using only **one** subdomain (e.g., `mysubdomain.mydomain.com`) per domain. Multiple custom domains for the same source are not supported.
