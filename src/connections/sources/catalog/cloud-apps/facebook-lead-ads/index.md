...
### Permissions
**Setup**
The following permissions are used to access the page information for the page dropdown, and the lead information for enrichment purposes inside FB leads ads service. More info [here] (https://developers.facebook.com/docs/marketing-api/guides/lead-ads/retrieving). This source cannot be set up without the below permissions. 
- pages_show_list
