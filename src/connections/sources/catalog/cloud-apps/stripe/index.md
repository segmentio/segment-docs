...
| `tax_rate`                        | object | Tax rates can be applied to invoices, subscriptions and Checkout Sessions to collect tax.                                                                                                                                                                                                                                                                                                                            |
...
| `available_on` | The date the transactions's net funds will become available in the Strip balance |
