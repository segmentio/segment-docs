...
If you need to collect the user’s IDFA to pass it to specific destinations, or for other uses, you can [follow these steps](TODO-steps) to collect and pass IDFA as a configuration item to the Segment SDK.
