...
<table class="api-table">
  ...
  <tr>
    ...
    <td>An ID to associated with the user when you don't know who they are (eg., [the anonymousId generated by `analytics.js`](/docs/connections/sources/catalog/libraries/website/javascript/#anonymous-id)) _Note: at least one of `userId` or `anonymousId` must be included in any identify call.</td>
  </tr>
  <tr>
...
<table>
  ...
  <tr>
    <td>`anonymousId` _String, optional_</td>
    <td>An ID to associated with the user when you don't know who they are (eg., [the anonymousId generated by `analytics.js`](/docs/connections/sources/catalog/libraries/website/javascript/#anonymous-id)) _Note: at least one of `userId` or `anonymousId` must be included in any track call.</td>
  </tr>
  <tr>
