---
title: Shopify Source (by Littledata) 
---
...
Here's an architectural diagram that shows how the Littledata app mediates data flow between Shopify and Segment. 

![](images/arch.png)

This integration is maintained by Littledata _and is not supported by Segment directly_. Please [reach out to their team](mailto:support@littledata.io) with any questions.
