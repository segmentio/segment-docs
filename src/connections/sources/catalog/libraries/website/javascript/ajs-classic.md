...
> <br><br>[Upgrade to Analytics.js 2.0](/docs/connections/sources/catalog/libraries/website/javascript/upgrade-to-ajs2) before access ends for Analytics.js Classic. See [Analytics.js 2.0](/docs/connections/sources/catalog/libraries/website/javascript/) to learn more the new Analytics.js source.
