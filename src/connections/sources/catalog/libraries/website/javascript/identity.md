...
Passing the user's `traits` into other events can be useful when an Actions destination is connected, as those fields would become available to be mapped within the destination's mappings.
