...
Calling the `debug` method turns on debug mode, which logs helpful messages to the console. Subsquent Segment events will generate messages in the developer console after you invoke `debug`.
