...
<table>
  ...
  <tr>
    ...
    <td>An ID to associated with the user when you don't know who they are (eg., [the anonymousId generated by `analytics.js`](https://segment.com/docs/sources/website/analytics.js/#anonymous-id))</td>
  </tr>
</table>
