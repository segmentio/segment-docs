...
10. Enter the configuration settings for your Databricks source. 
    ...
    * Please ensure Http Path in the above step begins like `/sql/1.0/warehouses/` and not `/sql/protocolv1/`. The latter one is for compute and that is not supported.
