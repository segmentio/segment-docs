...
7. Navigate to the destination settings tab and enable the destination. Note that, if the destination is disabled then Segment will not be able to start sync.
