...
![Screenshot of the popup that appears when you click the "Send test event" button. The popup reads "Are you sure you want to send this test event? Sending a test event will result in this event appearing in your destination alongside your existing data."](/guides/images/asset_Yxw1DJqb.png)
