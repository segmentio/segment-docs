...
5. Test the mapping with data from a sample event.
    The edit panel shows you the mapping output in the format for the destination tool. The “Select Object” option will send the entire object from the event; whereas, the “Edit Object” option allows you to map each individual property.   You can change your mapping as needed and re-test.
