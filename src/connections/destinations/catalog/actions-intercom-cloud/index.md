...
5. On the **Settings** tab, authenticate with Intercom using OAuth. Select the Intercom workspace to access from a dropdown list beside the statement "Segment wants to access".
