...
4. If you're using Segment's client-side `analytics.js` library, the Segment CDN updates in about 45 minutes, then asynchronously loads Delighted's Javascript library onto the page and begins sending data.
