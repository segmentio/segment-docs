...
### Limitations
At this time, Qualtrics as a destination is only available to customers on a Business Tier plan with Segment.

To link your Qualtrics destination in Segment to your Qualtrics workspace, [Qualtrics]([url](https://www.qualtrics.com/support/integrations/twilio-segment/twilio-segment-task/)) requires a Segment Token ([Public API Token]([url](https://app.segment.com/goto-my-workspace/settings/access-management/tokens))) that can only be generated by Business Tier customers, who have access to the [Public API]([url](https://segment.com/docs/api/public-api/)).
