...
{% include content/connection-modes.md %}
  ...
  4. The Segment CDN updates in about 45 minutes, and starts asynchronously loading Track JS onto your page. This means you should remove Track JS' snippet from your page.
