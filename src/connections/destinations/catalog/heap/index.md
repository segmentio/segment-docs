...
4. If you are using Segment's client-side `analytics.js` library to load Heap, Segment asynchronously loads Heap's JavaScript library onto your page for you, which means you should remove Heap’s snippet from your page. All native functionality of Heap, including auto-capturing of all events, will be available to you. 
