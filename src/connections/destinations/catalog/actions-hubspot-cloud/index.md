...
[HubSpot](https://www.hubspot.com/){:target="_blank"} is an all-in-one marketing tool that helps attract new leads and converts them into paying customers, with features like landing page creation and email automation. 
...
- **OAuth 2.0 support**: Authentication with HubSpot uses [OAuth 2.0](https://oauth.net/2/){:target="_blank"} instead of an API key.
