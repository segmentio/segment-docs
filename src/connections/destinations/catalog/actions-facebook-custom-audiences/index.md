...
- Ensure that the user connecting to the destination via OAuth has at least an "Advertiser" or "Admin" role on the ad account. To manage permissions and roles for an ad account reference this [Facebook doc](https://www.facebook.com/business/help/186007118118684?id=829106167281625).
