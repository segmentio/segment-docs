...
## In-App Messaging
The Customer.io Actions destination is built and maintained by our partner Customer.io, and does not currently support [in-app messaging](https://customer.io/docs/journeys/in-app-getting-started/#javascript-snippet). We recommend reaching out to them to express your interest in using in-app messaging with their Segment integration so they can update the integration to support it.
