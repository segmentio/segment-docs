...
10. Under Select mappings, select "properties.audience_key" as the “Segment Engage Audience Key.” Do not change any other defaults. Click **Save** and toggle to enable the mapping.
...
> info ""
> Please create the mapping with conditions ("Event Name" is "Audience Entered/Exited") only and don't hardcode the audience key in "Segment Engage Audience Key" field of mapping.
