...
> info ""
> Please create the mapping with trigger conditions ("Event Name" is "Audience Entered/Exited") and ("Event Property" "audience_key" is "<audience_key>") and hardcode the audience key in "Segment Engage Audience Key" field of mapping.
