...
> info ""
> It is recommended to create mapping for each audience that has been connected to the destination with the condition ("Event Property" "Audience Key" is "<audience_key>"). Please don't create the mapping with conditions like ("Event Name" is "Audience Entered/Exited") as this may cause event failure with other mappings which has been created with Audience key condition.
