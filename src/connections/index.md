...
### My source is showing events being delivered even though the source is disabled.

Sources that are disabled will still send data to Segments servers, however these events are discarded on ingestion and will not inccur charges or are sent to any destinations.
