...
> info ""
> **Get Access to Personas** Personas is available only to workspaces on our [Business Tier plan](https://segment.com/pricing/). If you’re a new customer or don’t have a Customer Success Manager, [request a demo](https://segment.com/demo/) and our team will walk you through the set up process.
> If you’re already a Segment customer on a Business Tier plan, contact your Customer Success Manager to get access to Personas.


## What is Personas?

Personas is a powerful personalization platform that enables companies to create unified customer profiles in Segment, to build and enrich audiences, and to activate audiences across marketing tools to power personalized experiences at scale.

With Personas, you compile lists of traits for each user, then create audiences which are lists of users that meet criteria you define. You can send user traits to your Segment destinations, and audience lists to specific Personas destinations.
...
Before you start setting up Personas, here are some features and terms that we’ll use in this documentation. The main parts of Personas are your Personas space(s), Audiences, and the Profile Explorer, and Traits (Computed, SQL,Custom).
