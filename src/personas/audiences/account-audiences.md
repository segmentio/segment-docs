...
- Unlike user-level audiences which can be [computed in real time](/docs/personas/audiences/#realtime-compute-vs-batch), account-level audiences can only be computed on an hourly, batched basis.
