...
The table below includes the _most important_ Personas Destinations that Segment supports today, and which we consider industry-standard tools that most businesses use for personalization and marketing. (This list doesn't include warehouses.)
