...
When you transfer a source from one workspace to another, the connected destinations will not be transfered, you will need to reconnect those destinations and settings.
