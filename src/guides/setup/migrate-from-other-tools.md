...
Since Event Category is required we’ll populate it with ‘All’ if you don’t specify one. You can read more about this in [our Google Analytics docs](https://segment.com/docs/integrations/google-analytics/#track).

### Ecommerce

Segment has full support for the Google Analytics E-Commere API and the [Enhanced E-Commerce API](https://segment.com/docs/integrations/google-analytics/#enhanced-ecommerce) as well. Make sure you follow [our e-commerce quickstart](https://help.segment.com/hc/en-us/articles/204812439-Ecommerce-Quickstart) to make sure you’ll be able to use all e-commerce features in the tools we support.
...
A full explanation can be found in [our Google Analytics docs](https://segment.com/docs/integrations/google-analytics/#custom-dimensions) page, but here’s a quick example:
...
To see a full list of Google Analytics features and how they work through Segment read[our Google Analytics docs page](https://segment.com/docs/integrations/google-analytics/#features).
...
For more information check out [our Mixpanel docs](https://segment.com/docs/integrations/mixpanel).
...
Read more in [our Mixpanel Increment Docs](https://segment.com/docs/integrations/mixpanel#increment).
