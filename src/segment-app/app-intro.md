...
In the left navigation bar, you see the main parts of the Segment application: [Sources](/docs/sources/), [Destinations](/docs/destinations/), [Privacy](/docs/privacy-portal/), and [Personas](/docs/personas/) and [Protocols](/docs/protocols/) if your subscription includes them.
...
Next up we have the Catalog. The catalog includes a list of all [sources](/docs/sources/) and [destinations](/docs/destinations/) available in Segment. You can search either by category, or name. When you click on a catalog tile, the tile shows instructions on how to connect the tool to your Segment workspace.
