...
> If you are interesting in joining the Public Preview, please send an email to beta@segment.com. The use is governed by the [Segment Acceptable Use Policy](https://segment.com/legal/acceptable-use-policy/). 
