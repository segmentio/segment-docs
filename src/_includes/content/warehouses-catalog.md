  ...
  <div class="destinations-catalog__section">
    <div class="flex flex--wrap waffle waffle--xlarge">
      ...
      {% for warehouse in warehouses %}
        {% if warehouse.categories contains "Warehouses" and warehouse.slug != "databricks-delta-lake" and warehouse.slug != "data-lakes" and warehouse.slug != "google-cloud-storage" %}
