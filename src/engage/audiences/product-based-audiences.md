...
- As soon as you complete your audience creation, it wll show a status of "live" with 0 customers. Please note that the audience is still computing, and the model is trying to determine which customers belong in that audience. **Segment recommends waiting at least 24 hours for an Audience to finish computing**. When the audience is truly ready for use, you will see the audience size update from 0 customers.
