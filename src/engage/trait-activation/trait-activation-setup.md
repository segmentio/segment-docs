...
> warning ""
> [Iterable](/docs/connections/destinations/catalog/iterable/) and [Zendesk](/docs/connections/destinations/catalog/zendesk/) are only supported for Trait Activation during beta. These two destinations will not be supported for Trait Activation after GA.
